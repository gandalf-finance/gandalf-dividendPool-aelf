...
namespace Awaken.Contracts.DividendPool
{
    ...
    public class DividendPoolContractTestModule : MainChainDAppContractTestModule
    {
        ...
        {
            context.Services.AddSingleton<IContractInitializationProvider, DividendPoolContractInitializationProvider>();
        }
        ...
        public override void OnPreApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                {
                    new DividendPoolContractInitializationProvider().ContractCodeName,
